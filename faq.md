...
### When is the airdrop?
The timing has not been announced. Follow [@Poly_Helper on X](https://x.com/Poly_Helper) for the latest updates.
...
Yes! Post feature requests in `#feedback` on [Discord](https://discord.gg/2RfMcye8fG) or message [@Poly_Helper on X](https://x.com/Poly_Helper).
